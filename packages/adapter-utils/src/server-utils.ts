...
export function buildPaperclipEnv(agent: { id: string; companyId: string; name?: string; companyName?: string }): Record<string, string> {
  ...
  if (agent.companyName) vars.PAPERCLIP_COMPANY_NAME = agent.companyName;
