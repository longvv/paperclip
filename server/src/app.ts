...
import masterTraceRoutes from "./routes/master-trace.js";
import { bmadRoutes } from "./routes/bmad.js";
...
export async function createApp(
  ...
  api.use("/master-trace", masterTraceRoutes);
  api.use("/bmad", bmadRoutes());
